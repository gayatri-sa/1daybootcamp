...
#
# @example
#   include exercises::ex10_templates
class exercises::ex10_templates {
    $classvariable = 'I am a class variable in exercises::ex10_templates'

    # declare other classes
    include forexercises::classa
    class {'exercises::withparams':
        var1 => 'Var1 from exercises::ex10_templates'
    }
